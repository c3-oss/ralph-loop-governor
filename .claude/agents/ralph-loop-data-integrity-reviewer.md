...
- Read matched domain guidance before deciding which data invariants apply.
...
- Treat downstream work built on an unaccepted data lane as a process risk to report separately from code findings.
